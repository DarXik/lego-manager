...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__supercharge_request_ip: string;
	...
	export const npm_package_devDependencies_svelte_geolocation: string;
	...
	export const npm_package_devDependencies__types_request_ip: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__supercharge_request_ip: string;
		...
		npm_package_devDependencies_svelte_geolocation: string;
		...
		npm_package_devDependencies__types_request_ip: string;
