    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const image = yield prisma_1.default.images.create({
                data: {
                    filename: originalName + (0, uniqid_1.default)(),
                    mimetype: fileType,
...
const post = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (fileBuffer) {
        yield saveImage(fileBuffer === null || fileBuffer === void 0 ? void 0 : fileBuffer.buffer, verifiedUser.user.id, fileBuffer === null || fileBuffer === void 0 ? void 0 : fileBuffer.mimetype, fileBuffer === null || fileBuffer === void 0 ? void 0 : fileBuffer.originalname);
    }
    try {
